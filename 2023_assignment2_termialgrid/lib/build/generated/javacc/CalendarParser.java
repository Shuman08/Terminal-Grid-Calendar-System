...
public class CalendarParser implements CalendarParserConstants {
  ...
  final public void PluginDeclaration() throws ParseException {
    jj_consume_token(7);
    jj_consume_token(STRING);
    jj_consume_token(8);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
  ...
  final public void ScriptDeclaration() throws ParseException {
    jj_consume_token(12);
    jj_consume_token(STRING);
}

  /** Generated Token Manager. */
  public CalendarParserTokenManager token_source;
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x10a0,0x10a0,0x44,0x200,0x10,};
	}
